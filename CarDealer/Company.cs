...
namespace CarDealer
{
    public partial class Company : Form
    {
        ...
        {
            nameBox.Text = companyDataGridView.SelectedRows[0].Cells[1].Value.ToString();
            ...
            {
                key = Convert.ToInt32(companyDataGridView.SelectedRows[0].Cells[0].Value.ToString());
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("INSERT INTO company (name) VALUES (@name)", conn);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                ...
                else
                {
                    ...
                    {
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("UPDATE company SET name = @name WHERE id = @ID", conn);
                        cmd.Parameters.AddWithValue("@name", nameBox.Text);
        ...
        private void searchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM company WHERE name LIKE @searchName", conn);
                cmd.Parameters.AddWithValue("@searchName", '%' + searchBox.Text + '%');
